# Generated by Django 3.1.6 on 2021-02-06 01:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('prep', '준비중'), ('ord', '주문'), ('done', '완료')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='SampleProduct',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobtitle', models.CharField(choices=[('J50', '아르바이트'), ('J20', '메니저'), ('J40', '사원'), ('J10', 'CEO'), ('J30', '메니저')], max_length=20)),
