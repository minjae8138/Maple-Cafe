    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('done', '완료'), ('prep', '준비중'), ('ord', '주문')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='SampleProduct',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobtitle', models.CharField(choices=[('J20', '메니저'), ('J30', '메니저'), ('J50', '아르바이트'), ('J40', '사원'), ('J10', 'CEO')], max_length=20)),
